...
void SettingsDialog::accept()
{
    ...
    // Engine settings
    settings.setGoogleCloudApiKey(ui->googleCloudApiKeyTextEdit->text().toUtf8());
...
void SettingsDialog::restoreDefaults()
{
    ...
    // Engine settings
    ui->googleCloudApiKeyTextEdit->setText(AppSettings::defaultGoogleCloudApiKey());
...
void SettingsDialog::loadSettings()
{
    ...
    // Engines settings
    ui->googleCloudApiKeyTextEdit->setText(settings.googleCloudApiKey());
