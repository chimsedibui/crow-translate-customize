...
QByteArray AppSettings::googleCloudApiKey() const
{
    return m_settings->value(QStringLiteral("Translation/GoogleCloudApiKey"), defaultGoogleCloudApiKey()).toByteArray();
}

void AppSettings::setGoogleCloudApiKey(const QByteArray &apiKey)
{
    m_settings->setValue(QStringLiteral("Translation/GoogleCloudApiKey"), apiKey);
}

QByteArray AppSettings::defaultGoogleCloudApiKey()
{
    return {};
}
