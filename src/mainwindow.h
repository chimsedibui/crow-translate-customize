...
#include "translator/googlecloudtranslator.h"
...
private:
    ...
    /// Whether the "Google" engine should be routed through GoogleCloudTranslator (a
    /// Google Cloud API key is configured) instead of QOnlineTranslator's scraped engine.
    bool useGoogleCloud() const;
    ...
    GoogleCloudTranslator *m_googleCloudTranslator;
    TrayIcon *m_trayIcon;
