...
public:
    ...
    /**
     * @brief Renders translation data (translation, transliteration, options, examples,
     *        error) into the edit.
     *
     * Templated so it accepts both QOnlineTranslator and any drop-in replacement (e.g.
     * GoogleCloudTranslator) exposing the same read accessors.
     */
    template<typename Translator>
    bool parseTranslationData(Translator *translator);
...
template<typename Translator>
bool TranslationEdit::parseTranslationData(Translator *translator)
{
    // Check for error
